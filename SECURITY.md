...
or security-advisory channel if it is enabled for the repository. Revoke the
credential at its provider before treating removal from Git history as a fix.

General product suggestions and non-sensitive defects can use normal issues.
